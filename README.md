...
* [📦 Binary Formats & PE Tools](#binary-format-tools)
* [🔍 Disassemblers & Decompilers](#disassemblers--decompilers)
* [🧠 Binary Analysis Frameworks](#binary-analysis-frameworks)
* [⚙ Bytecode Tools (.NET, Java)](#bytecode-analysis)
* [🪝 Import Rebuilding](#import-reconstruction)
* [🔎 Dynamic Analysis](#dynamic-analysis)
* [🐎 Debugging Tools](#debugging-tools)
* [🍏 MacOS RE](#mac-decryption-tools)
* [📄 Document & File Analysis](#document-analysis)
* [🧬 Scripting for RE](#scripting-for-re)
* [📱 Android RE](#android-reverse-engineering)
* [🧿 YARA Rules & Malware Hunting](#yara-malware-detection-rules)
...
> 🔥 Learn from the pros and top universities

* [Open Security Training – Intro to RE](http://opensecuritytraining.info/Training.html)
* [Lena’s Reversing for Newbies](https://tuts4you.com/download.php?list.17)
* [Modern Binary Exploitation (RPISEC)](http://security.cs.rpi.edu/courses/binexp-spring2015/)
* [RPISEC Malware Analysis Course](https://github.com/RPISEC/Malware)
* [REcon Trainings](https://recon.cx/)
* [Corelan Exploit Writing](https://www.corelan.be/index.php/articles/#cat_exploit-writing-tutorials)
* [SANS FOR610: Reverse-Engineering Malware](https://www.sans.org/cyber-security-courses/reverse-engineering-malware/)
* [Offensive Security Exploit Dev](https://www.offensive-security.com/information-security-training/)
* [✨ x86re.com Interactive RE Platform](https://x86re.com/index.html) — browser-based x86 RE playground

---

## 🧪 Practice Platforms

> 🎯 Learn by doing — RE challenges, CTFs, CrackMes

* [Crackmes.one](https://crackmes.one)
* [Root Me – Cracking](https://www.root-me.org/en/Challenges/Cracking)
* [HackTheBox Reversing](https://www.hackthebox.com/)
* [Flare-on Challenge](https://www.flare-on.com/)
...
* [HexFiend (macOS)](http://ridiculousfish.com/hexfiend/)
...
* [PEiD (legacy)](https://tuts4you.com/download.php?view.398)
* [Detect It Easy (DIE)](https://ntinfo.biz/)
* [Cerbero Profiler](https://cerbero.io/profiler/)
* [MachoView (macOS)](https://github.com/gdbinit/MachOView)
...
* [IDA Free / Pro](https://hex-rays.com)
* [Binary Ninja](https://binary.ninja/)
* [Radare2](https://rada.re/n/)
* [Cutter (GUI for Radare2)](https://cutter.re/)
...
* [Binary Analysis Platform (BAP)](https://github.com/BinaryAnalysisPlatform/bap)
* [z3 (Symbolic Solver)](https://github.com/Z3Prover/z3)

---

## ⚙ Bytecode Analysis

* [.NET: dnSpy](https://github.com/dnSpy/dnSpy)
* [Java: Bytecode Viewer](https://bytecodeviewer.com/)
* [Java: JPEXS Decompiler](https://www.free-decompiler.com/flash/)
* [Java: Procyon](https://github.com/mstrobel/procyon)
...
* [ImpRec](https://www.woodmann.com/collaborative/tools/index.php/ImpREC)
...
* [ProcMon / ProcExp](https://learn.microsoft.com/en-us/sysinternals/)
...
* [OllyDbg (v1/v2)](http://www.ollydbg.de/)
* [WinDbg](https://learn.microsoft.com/en-us/windows-hardware/drivers/debugger/)
* [GDB (Linux)](https://www.gnu.org/software/gdb/)
* [LLDB (macOS/LLVM)](http://lldb.llvm.org/)
...
* [HexRays IDA Plugin Contest](https://hex-rays.com/contests/)
...
* [YARA Cheatsheet](https://gist.github.com/0xtyh/eeabc765e9befad9b80a)

---

## 🛠 Bonus Links

* [Top Ethical Hacking Books](http://www.kalitut.com/2016/12/best-ethical-hacking-books.html)
* [Top Reverse Engineering Books](http://www.kalitut.com/2017/01/Best-reverse-engineering-books.html)
* [Awesome Reverse Engineering GitHub](https://github.com/shellphish/awesome-re)
* [Reverse Engineering Reddit](https://www.reddit.com/r/ReverseEngineering/)
...
* ✅ Feel Free to Fork
* ✅ Add your findings too which can help other peoples too
